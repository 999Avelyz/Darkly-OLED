...
#include "darkystyleconfig.h"

#include "../config-darky.h"
#include "../darky.h"
#include "darkystyleconfigdata.h"
#include "darkystyleversion.h"
...
{
    return new Darky::StyleConfig(parent);
}
}
...
void StyleConfig::save()
{
    ...
    QDBusMessage message(
        QDBusMessage::createSignal(QStringLiteral("/DarkyStyle"), QStringLiteral("org.kde.Darky.Style"), QStringLiteral("reparseConfiguration")));
...
void StyleConfig::load()
{
    ...
    _versionNumber->setText(DARKY_VERSION_STRING);
