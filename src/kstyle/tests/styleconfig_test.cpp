...
void StyleConfigTest::testSliderDefaultValue()
{
    ...
    int defaultValue = Darky::StyleConfigData::dolphinViewOpacity();
...
void StyleConfigTest::testOpacityAlphaConversion()
{
    ...
    qreal alpha = Darky::StyleConfigData::dolphinViewOpacity() / 100.0;
    QCOMPARE(alpha, 0.42);
}
...
void StyleConfigTest::testTransparencyConditionCheck()
{
    ...
    auto isTransparent = []() -> bool {
        return Darky::StyleConfigData::dolphinViewOpacity() < 100;
    };
