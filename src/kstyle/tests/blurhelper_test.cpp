...
void BlurHelperTest::testNoBlurWhenOpacity100()
{
    ...
    bool shouldRegisterBlur = (Darky::StyleConfigData::dolphinViewOpacity() < 100);
...
void BlurHelperTest::testBlurEnabledWhenOpacityLessThan100()
{
    ...
    shouldRegisterBlur = (Darky::StyleConfigData::dolphinViewOpacity() < 100);
    QVERIFY(shouldRegisterBlur);
...
void BlurHelperTest::testBlurRegionIncludesKItemListContainer()
{
    ...
    bool viewOpacityLessThan100 = Darky::StyleConfigData::dolphinViewOpacity() < 100;
...
void BlurHelperTest::testBlurIndependentOfSidebarOpacity()
{
    ...
    Darky::StyleConfigData::setDolphinViewOpacity(50);
    Darky::StyleConfigData::setDolphinSidebarOpacity(100);

    bool shouldBlurView = (Darky::StyleConfigData::dolphinViewOpacity() < 100);
    bool shouldBlurSidebar = (Darky::StyleConfigData::dolphinSidebarOpacity() < 100);
    ...
    Darky::StyleConfigData::setDolphinViewOpacity(100);
    Darky::StyleConfigData::setDolphinSidebarOpacity(50);

    shouldBlurView = (Darky::StyleConfigData::dolphinViewOpacity() < 100);
    shouldBlurSidebar = (Darky::StyleConfigData::dolphinSidebarOpacity() < 100);
