#ifndef darky_helper_h
#define darky_helper_h
...
//* darky style helper class.
/** contains utility functions used at multiple places in both darky style and darky window decoration */
