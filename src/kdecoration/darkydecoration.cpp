...
#include "darkydecoration.h"

#include "config-darky.h"
#include "darky.h"
#include "darkysettingsprovider.h"

#include "darkybutton.h"

#include "darkyboxshadowrenderer.h"
...
K_PLUGIN_FACTORY_WITH_JSON(DarkyDecoFactory, "darky.json", registerPlugin<Darky::Decoration>(); registerPlugin<Darky::Button>();)
...
{
    switch (size) {
    case Darky::InternalSettings::ShadowNone:
        return s_shadowParams[0];
    case Darky::InternalSettings::ShadowSmall:
        return s_shadowParams[1];
    case Darky::InternalSettings::ShadowMedium:
        return s_shadowParams[2];
    case Darky::InternalSettings::ShadowLarge:
        return s_shadowParams[3];
    case Darky::InternalSettings::ShadowVeryLarge:
